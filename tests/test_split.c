...
void test_basic_split(void)
{
    ...
    TEST_CHECK(my_strcmp(r[0], "a") == 0);
    TEST_CHECK(my_strcmp(r[1], "b") == 0);
    TEST_CHECK(my_strcmp(r[2], "c") == 0);
    TEST_CHECK(r[3] == NULL);
    free_split(&r);
}
...
void test_single_word(void)
{
    ...
    TEST_CHECK(my_strcmp(r[0], "hello") == 0);
    TEST_CHECK(r[1] == NULL);
    free_split(&r);
}
...
void test_leading_trailing(void)
{
    ...
    TEST_CHECK(my_strcmp(r1[0], "a") == 0);
    TEST_CHECK(my_strcmp(r1[1], "b") == 0);
    TEST_CHECK(r1[2] == NULL);
    free_split(&r1);

    char **r2 = my_split("a,b,", ',');
    TEST_CHECK(my_strcmp(r2[0], "a") == 0);
    TEST_CHECK(my_strcmp(r2[1], "b") == 0);
...
void test_spaces(void)
{
    ...
    TEST_CHECK(my_strcmp(r[0], "one") == 0);
    TEST_CHECK(my_strcmp(r[1], "two") == 0);
    TEST_CHECK(my_strcmp(r[2], "three") == 0);
    TEST_CHECK(r[3] == NULL);
    free_split(&r);
}
